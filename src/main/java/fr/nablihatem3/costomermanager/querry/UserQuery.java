...
public class UserQuery {
    ...
    public static final String IS_VERIFICATION_CODE_EXPIRED = "SELECT expiration_date < NOW() AS is_expired FROM TwoFactorVerifications WHERE code = :code";
    ...
    public static final String SELECT_CODE_EXPIRATION_QUERY = "SELECT expiration_date < NOW() AS is_expired FROM ResetPasswordVerifications WHERE url = :url";
    ...
    public static final String UPDATE_USER_TO_ENABLED_QUERY = "UPDATE Users SET enabled = :enabled WHERE id = :id";
}
